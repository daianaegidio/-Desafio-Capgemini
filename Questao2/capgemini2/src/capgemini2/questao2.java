...
public class questao2 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Senha Inválida!Faltam"+ cont +" Caracteres " );
		...
		boolean digito = senha.chars().anyMatch(x -> Character.isDigit(x));
		 if (!digito) {
	           ...
	           System.out.println("Obrigatório possuir no mínimo 1 digito! ");
	           validacao=true;
	       }
		 ...
		 if (!maiusculo) {
	           ...
	           System.out.println("Obrigatório possuir no mínimo uma letra maiúscula! ");
	           validacao=true;
		 }
		 ...
		 boolean minusculo = senha.chars().anyMatch(x -> Character.isLowerCase(x));
	       if (!minusculo) {
	           ...
	           System.out.println("Obrigatório possuir no mínimo uma letra minúscula!");
	           validacao=true;
	       }
	       ...
	       if(!validacaoCaractere) {
	    	   ...
	    	   System.out.println("Obrigatório possuir no mínimo um caractere especial!");
	    	   validacao=true;
	       }
	       
	       if(!validacao) {
	    	   System.out.println("Sua Senha é forte!Possui todos os requisitos.");
	       }
